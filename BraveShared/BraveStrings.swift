...
extension Strings {
  ...
  public static let openTabsMenuItem = NSLocalizedString("PasswordsMenuItem", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Open Tabs", comment: "Title for open tabs menu item")
