...
extension BrowserViewController {
  ...
  func privacyFeaturesMenuSection(_ menuController: MenuViewController) -> some View {
    VStack(alignment: .leading, spacing: 5) {
      ...
      MenuItemButton(
        icon: UIImage(named: "playlist_menu", in: .module, compatibleWith: nil)!.template,
      ...
      if !PrivateBrowsingManager.shared.isPrivateBrowsing {
        ...
        if Preferences.General.isFirstLaunch.value || (!Preferences.General.isFirstLaunch.value && Preferences.BraveNews.isEnabled.value) {
          MenuItemButton(
            icon: UIImage(named: "menu_brave_news", in: .module, compatibleWith: nil)!.template,
        ...
        MenuItemButton(
          icon: UIImage(named: "menu-brave-talk", in: .module, compatibleWith: nil)!.template,
      ...
      MenuItemButton(
        icon: UIImage(named: "menu-crypto", in: .module, compatibleWith: nil)!.template,
  ...
  func destinationMenuSection(_ menuController: MenuViewController, isShownOnWebPage: Bool) -> some View {
    VStack(spacing: 0) {
      MenuItemButton(icon: UIImage(named: "menu_bookmarks", in: .module, compatibleWith: nil)!.template, title: Strings.bookmarksMenuItem) { [unowned self, unowned menuController] in
      ...
      MenuItemButton(icon: UIImage(named: "menu-history", in: .module, compatibleWith: nil)!.template, title: Strings.historyMenuItem) { [unowned self, unowned menuController] in
      ...
      MenuItemButton(icon: UIImage(named: "menu-downloads", in: .module, compatibleWith: nil)!.template, title: Strings.downloadsMenuItem) { [unowned self] in
      ...
      if isShownOnWebPage {
        ...
        MenuItemButton(icon: UIImage(named: "playlist_menu", in: .module, compatibleWith: nil)!.template, title: Strings.playlistMenuItem) { [weak self] in
          guard let self = self else { return }
          self.presentPlaylistController()
        }
      }
      MenuItemButton(icon: UIImage(named: "menu-settings", in: .module, compatibleWith: nil)!.template, title: Strings.settingsMenuItem) { [unowned self, unowned menuController] in
