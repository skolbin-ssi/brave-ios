...
class TabLocationView: UIView {
  ...
  var loading: Bool = false {
    didSet {
      if loading {
        reloadButton.setImage(UIImage(named: "nav-stop", in: .module, compatibleWith: nil)!.template, for: .normal)
        reloadButton.accessibilityLabel = Strings.tabToolbarStopButtonAccessibilityLabel
      } else {
        reloadButton.setImage(UIImage(named: "nav-refresh", in: .module, compatibleWith: nil)!.template, for: .normal)
  ...
  private func updateLockImageView() {
    ...
    case .insecure:
      lockImageView.setImage(UIImage(named: "insecure-site-icon", in: .module, compatibleWith: nil)!, for: .normal)
    case .secure, .unknown:
      lockImageView.setImage(UIImage(named: "lock_verified", in: .module, compatibleWith: nil)!.template, for: .normal)
    }
  }
  ...
  private(set) lazy var lockImageView = ToolbarButton(top: true).then {
    $0.setImage(UIImage(named: "lock_verified", in: .module, compatibleWith: nil)!.template, for: .normal)
    $0.isHidden = true
  ...
  lazy var reloadButton = ToolbarButton(top: true).then {
    ...
    $0.setImage(UIImage(named: "nav-refresh", in: .module, compatibleWith: nil)!.template, for: .normal)
  ...
  lazy var shieldsButton: ToolbarButton = {
    ...
    button.setImage(UIImage(named: "shields-menu-icon", in: .module, compatibleWith: nil)!, for: .normal)
